...
# =============================================================================
#     m.addConstr(V[(-100, -100), 1, 12] == 1 , name = 'ub') 
#     m.addConstr(V[(4,1), 1, 3] == 1 , name = 'ub')  
#       
#     m.addConstr(V[(-100, -100), 2, 11] == 1 , name = 'ub')    
#     m.addConstr(V[(4,1), 2, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(4,2), 2, 3] == 1 , name = 'ub')     
#     
#     m.addConstr(V[(-100, -100), 3, 11] == 1 , name = 'ub')     
#     m.addConstr(V[(4,2), 3, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(4,3), 3, 3] == 1 , name = 'ub')       
#     
#     m.addConstr(V[(-100, -100), 4, 9] == 1 , name = 'ub')    
#     m.addConstr(V[(4,1), 4, 2] == 1 , name = 'ub')  
#     m.addConstr(V[(4,3), 4, 1] == 1 , name = 'ub')    
#     m.addConstr(V[(4,4), 4, 3] == 1 , name = 'ub')       
#     
#     m.addConstr(V[(-100, -100), 5, 9] == 1 , name = 'ub')     
#     m.addConstr(V[(4,2), 5, 2] == 1 , name = 'ub')          
#     m.addConstr(V[(4,4), 5, 1] == 1 , name = 'ub')          
#     m.addConstr(V[(4,5), 5, 2] == 1 , name = 'ub')          
#     m.addConstr(V[(5,4), 5, 1] == 1 , name = 'ub')          
#     
#     m.addConstr(V[(-100, -100), 6, 9] == 1 , name = 'ub')     
#     m.addConstr(V[(4,3), 6, 2] == 1 , name = 'ub')   
#     m.addConstr(V[(5,4), 6, 1] == 1 , name = 'ub')       
#     m.addConstr(V[(5,5), 6, 3] == 1 , name = 'ub')    
#     
#     m.addConstr(V[(4,1), 7, 9] == 1 , name = 'ub')   
#     m.addConstr(V[(4,4), 7, 2] == 1 , name = 'ub')  
#     m.addConstr(V[(5,5), 7, 1] == 1 , name = 'ub')    
#     m.addConstr(V[(5,6), 7, 1] == 1 , name = 'ub')     
#     m.addConstr(V[(6,4), 7, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(6,5), 7, 1] == 1 , name = 'ub')    
#       
#     m.addConstr(V[(5,5), 8, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(6,5), 8, 2] == 1 , name = 'ub')     
#     m.addConstr(V[(7,4), 8, 1] == 1 , name = 'ub')   
#     
#     m.addConstr(V[(5,5), 9, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(6,4), 9, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(6,5), 9, 1] == 1 , name = 'ub') 
#     m.addConstr(V[(7,5), 9, 2] == 1 , name = 'ub') 
#     m.addConstr(V[(8,4), 9, 1] == 1 , name = 'ub') 
#     
#     m.addConstr(V[(5,6), 10, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(6,6), 10, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(7,4), 10, 3] == 1 , name = 'ub')  
#     m.addConstr(V[(9,4), 10, 1] == 1 , name = 'ub')          
#     
#     m.addConstr(V[(4,4), 11, 2] == 1 , name = 'ub')  
#     m.addConstr(V[(4,5), 11, 3] == 1 , name = 'ub')  
#     m.addConstr(V[(5,4), 11, 4] == 1 , name = 'ub')  
#     m.addConstr(V[(5,6), 11, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(6,6), 11, 1] == 1 , name = 'ub')     
#     m.addConstr(V[(8,4), 11, 3] == 1 , name = 'ub')       
#     
#     m.addConstr(V[(3,5), 12, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(4,5), 12, 2] == 1 , name = 'ub')   
#     m.addConstr(V[(4,6), 12, 2] == 1 , name = 'ub')  
#     m.addConstr(V[(5,5), 12, 4] == 1 , name = 'ub')   
#     m.addConstr(V[(6,4), 12, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(6,6), 12, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(9,4), 12, 3] == 1 , name = 'ub')   
#     
#     m.addConstr(V[(4,5), 13, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(4,6), 13, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(5,4), 13, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(5,5), 13, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(5,6), 13, 3] == 1 , name = 'ub')    
#     m.addConstr(V[(6,4), 13, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(6,5), 13, 3] == 1 , name = 'ub')  
#       
#     m.addConstr(V[(4,5), 14, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(5,4), 14, 1] == 1 , name = 'ub')  
#     m.addConstr(V[(5,5), 14, 1] == 1 , name = 'ub')  
#       
#     m.addConstr(V[(4,5), 15, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(5,4), 15, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(5,5), 15, 1] == 1 , name = 'ub')   
#     m.addConstr(V[(5,6), 15, 2] == 1 , name = 'ub')   
#     m.addConstr(V[(6,5), 15, 2] == 1 , name = 'ub')         
# =============================================================================
    ...
    #m.addConstr(V[(4,5), 16, 2] == 1 , name = 'ub')  
    #m.addConstr(V[(4,6), 16, 1] == 1 , name = 'ub')  
    #m.addConstr(V[(5,5), 16, 2] == 1 , name = 'ub')   
    #m.addConstr(V[(6,5), 16, 1] == 1 , name = 'ub')    
    #m.addConstr(V[(6,6), 16, 1] == 1 , name = 'ub')            
    #m.addConstr(V[(7,5), 16, 1] == 1 , name = 'ub')   
    #m.addConstr(V[(5,4), 17, 2] == 1 , name = 'ub')   
    #m.addConstr(V[(5,5), 17, 1] == 1 , name = 'ub')  
    #m.addConstr(V[(6,6), 17, 1] == 1 , name = 'ub')         
    #m.addConstr(V[(4,5), 18, 1] == 1 , name = 'ub')  
    #m.addConstr(V[(5,4), 18, 1] == 1 , name = 'ub')   
    #m.addConstr(V[(5,5), 18, 1] == 1 , name = 'ub')  
    #m.addConstr(V[(6,5), 18, 1] == 1 , name = 'ub')   
    #m.addConstr(V[(6,6), 18, 1] == 1 , name = 'ub')        
    #m.addConstr(V[(4,6), 19, 1] == 1 , name = 'ub')  
    #m.addConstr(V[(5,6), 19, 1] == 1 , name = 'ub')   
    #m.addConstr(V[(6,6), 19, 1] == 1 , name = 'ub')         
    #m.addConstr(V[(4,5), 20, 1] == 1 , name = 'ub')  
    #m.addConstr(V[(5,5), 20, 1] == 1 , name = 'ub')   
    ##m.addConstr(V[(6,5), 20, 1] == 1 , name = 'ub')   
...
"""
15: {"gap": 0.008287695553812546, "time": 902.8198430538177, "ub": 0.4575846465462611, "lb": 0.4538234955797293, "largest_num": 6,"best_ub_sol_X": [[[1, [-100, -100], [4, 1], 0], 2.0], [[1, [-100, -100], [-100, -100], 0], 3.0], [[1, [4, 1], [4, 2], 1], 2.0], [[1, [-100, -100], [4, 1], 1], 1.0], [[1, [-100, -100], [-100, -100], 1], 2.0], [[1, [4, 1], [4, 2], 2], 1.0], [[1, [4, 2], [4, 3], 2], 2.0], [[1, [-100, -100], [-100, -100], 2], 2.0], [[1, [4, 2], [4, 3], 3], 1.0], [[1, [4, 3], [4, 4], 3], 2.0], [[1, [-100, -100], [4, 1], 3], 2.0], [[1, [4, 1], [4, 2], 4], 2.0], [[1, [4, 3], [4, 4], 4], 1.0], [[1, [4, 4], [4, 5], 4], 1.0], [[1, [4, 4], [5, 4], 4], 1.0], [[1, [4, 2], [4, 3], 5], 2.0], [[1, [4, 4], [4, 5], 5], 1.0], [[1, [4, 5], [5, 5], 5], 1.0], [[1, [5, 4], [5, 5], 5], 1.0], [[1, [4, 3], [4, 4], 6], 2.0], [[1, [4, 5], [5, 5], 6], 1.0], [[1, [5, 5], [5, 6], 6], 2.0], [[1, [4, 4], [4, 5], 7], 1.0], [[1, [4, 4], [5, 4], 7], 1.0], [[1, [5, 5], [6, 5], 7], 1.0], [[1, [5, 6], [5, 5], 7], 1.0], [[1, [5, 6], [5, 6], 7], 1.0], [[1, [4, 5], [5, 5], 8], 1.0], [[1, [5, 4], [6, 4], 8], 1.0], [[1, [5, 5], [6, 5], 8], 1.0], [[1, [5, 6], [6, 6], 8], 1.0], [[1, [6, 5], [7, 5], 8], 1.0], [[1, [5, 5], [5, 6], 9], 1.0], [[1, [6, 4], [7, 4], 9], 1.0], [[1, [6, 5], [7, 5], 9], 1.0], [[1, [6, 6], [6, 6], 9], 1.0], [[1, [7, 5], [7, 4], 9], 1.0], [[1, [5, 6], [5, 6], 10], 1.0], [[1, [6, 6], [6, 5], 10], 1.0], [[1, [7, 4], [8, 4], 10], 2.0], [[1, [7, 5], [7, 4], 10], 1.0], [[1, [5, 6], [4, 6], 11], 1.0], [[1, [6, 5], [6, 6], 11], 1.0], [[1, [7, 4], [8, 4], 11], 1.0], [[1, [8, 4], [9, 4], 11], 2.0], [[1, [4, 6], [5, 6], 12], 1.0], [[1, [6, 6], [5, 6], 12], 1.0], [[1, [8, 4], [9, 4], 12], 1.0], [[1, [9, 4], [-100, 100], 12], 2.0], [[1, [5, 6], [5, 7], 13], 0.86], [[1, [5, 6], [6, 6], 13], 1.14], [[1, [9, 4], [-100, 100], 13], 1.0], [[1, [-100, 100], [-100, 100], 13], 2.0], [[1, [5, 7], [5, 6], 14], 0.86], [[1, [6, 6], [5, 6], 14], 0.14], [[1, [6, 6], [6, 5], 14], 1.0], [[1, [-100, 100], [-100, 100], 14], 3.0], [[1, [5, 6], [5, 7], 15], 1.0], [[1, [6, 5], [6, 4], 15], 1.0], [[1, [-100, 100], [-100, 100], 15], 3.0], [[2, [-100, -100], [-100, -100], 0], 10.0], [[2, [-100, -100], [-100, -100], 1], 10.0], [[2, [-100, -100], [-100, -100], 2], 10.0], [[2, [-100, -100], [4, 1], 3], 1.0], [[2, [-100, -100], [-100, -100], 3], 9.0], [[2, [4, 1], [4, 2], 4], 1.0], [[2, [-100, -100], [-100, -100], 4], 9.0], [[2, [4, 2], [4, 3], 5], 1.0], [[2, [-100, -100], [-100, -100], 5], 9.0], [[2, [4, 3], [4, 4], 6], 1.0], [[2, [-100, -100], [4, 1], 6], 9.0], [[2, [4, 1], [4, 2], 7], 7.45], [[2, [4, 1], [5, 1], 7], 1.55], [[2, [4, 4], [5, 4], 7], 1.0], [[2, [