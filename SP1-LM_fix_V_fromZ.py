...
for ending_time in ending_time_grid:
    ...
    m.addConstr(V[(-100, -100), 1, 15] == 1 , name = 'ub') 
    m.addConstr(V[(-100, -100), 2, 15] == 1 , name = 'ub')  
    m.addConstr(V[(-100, -100), 3, 15] == 1 , name = 'ub')   
    
    m.addConstr(V[(-100, -100), 4, 10] == 1 , name = 'ub')    
    m.addConstr(V[(4,1), 4, 5] == 1 , name = 'ub')       
    
    m.addConstr(V[(-100, -100), 5, 10] == 1 , name = 'ub')     
    m.addConstr(V[(4,2), 5, 5] == 1 , name = 'ub')          
    
    m.addConstr(V[(4,1), 6, 10] == 1 , name = 'ub')     
    m.addConstr(V[(4,3), 6, 3] == 1 , name = 'ub')      
    m.addConstr(V[(5,2), 6, 2] == 1 , name = 'ub')   
    
    m.addConstr(V[(4,2), 7, 10] == 1 , name = 'ub')   
    m.addConstr(V[(4,4), 7, 3] == 1 , name = 'ub')  
    m.addConstr(V[(5,3), 7, 2] == 1 , name = 'ub')    
      
    m.addConstr(V[(4,5), 8, 3] == 1 , name = 'ub')  
    m.addConstr(V[(5,4), 8, 2] == 1 , name = 'ub')   
    
    m.addConstr(V[(5,5), 9, 3] == 1 , name = 'ub')  
     
    m.addConstr(V[(4,4), 10, 1] == 1 , name = 'ub')     
    m.addConstr(V[(4,5), 10, 5] == 1 , name = 'ub') 
    m.addConstr(V[(5,4), 10, 5] == 1 , name = 'ub')  
    m.addConstr(V[(5,6), 10, 2] == 1 , name = 'ub') 
    m.addConstr(V[(6,5), 10, 2] == 1 , name = 'ub')          
    
    m.addConstr(V[(5,4), 11, 2] == 1 , name = 'ub')  
    m.addConstr(V[(5,5), 11, 4] == 1 , name = 'ub')     
    m.addConstr(V[(5,6), 11, 1] == 1 , name = 'ub')       
    m.addConstr(V[(6,5), 11, 2] == 1 , name = 'ub')     
    
    m.addConstr(V[(4,5), 12, 2] == 1 , name = 'ub')  
    m.addConstr(V[(4,6), 12, 1] == 1 , name = 'ub')  
    m.addConstr(V[(5,5), 12, 2] == 1 , name = 'ub')   
    m.addConstr(V[(5,6), 12, 3] == 1 , name = 'ub')     
    m.addConstr(V[(6,5), 12, 4] == 1 , name = 'ub')       
    m.addConstr(V[(6,6), 12, 3] == 1 , name = 'ub')      
    ...
    print('********** optimal solution for W **********')
    sub_W = sorted(sub_W, key = lambda x: x[1])
    cut = 500
    for sub in sub_W[:cut]:
        if W[sub].X != 0:
            print(sub, W[sub].X)            
    
    cut_2 = 1000
    
    for sub in sub_W[cut: cut_2]:
        if W[sub].X != 0:
            print(sub, W[sub].X)       
    
    for sub in sub_W[cut_2: ]:
        if W[sub].X != 0:
            print(sub, W[sub].X)    
    
    
    print('********** optimal solution for P **********')
    sub_P = sorted(sub_P, key = lambda x: x[1])
    cut = 500
    for sub in sub_P[:cut]:
        if P[sub].X != 0:
            print(sub, P[sub].X)            
    
    cut_2 = 1000
    
    for sub in sub_P[cut: cut_2]:
        if P[sub].X != 0:
            print(sub, P[sub].X)            
    
    cut_3 = 1500    
    
    for sub in sub_P[cut_2: cut_3]:
        if P[sub].X != 0:
            print(sub, P[sub].X)  
    
    for sub in sub_P[cut_3: ]:
        if P[sub].X != 0:
            print(sub, P[sub].X)       
