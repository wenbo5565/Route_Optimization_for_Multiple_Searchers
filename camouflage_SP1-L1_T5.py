...
# ending_time_grid = list(range(7, 16))
type_1_num = [1, 2, 3]
type_2_num = [1, 3, 5, 7, 9]

for num_1 in type_1_num:
    for num_2 in type_2_num:
        print('===========================')
        print('type 1 num is', num_1)
        print('type 2 num is', num_2)
        print('===========================')
    ...
    # =============================================================================
        ...
        alpha = -3 * np.log(0.4) / 2 # use a fixed number
